...
(function loadUtils() {
    ...
    if (typeof files !== 'undefined' && files.exists) {
        var autoxPaths = [
            BASE_PATH + '/shared/Utils.js',
            BASE_PATH + '/android/../shared/Utils.js',
            '/sdcard/doai-bot/shared/Utils.js'
        ];
    ...
    try {
        Utils = require('./shared/Utils.js');
        console.log('[EvidenceManager] Utils 로드 성공 (Node.js fallback)');
        return;
    } catch (e2) {
        // fallback failed
    }
