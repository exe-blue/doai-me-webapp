...
/**
 * SelectTrigger - RetroUI/NeoBrutalist 스타일 선택 트리거
 */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between bg-background px-3 py-2 text-sm",
...
/**
 * SelectContent - RetroUI/NeoBrutalist 스타일 선택 콘텐츠
 */
...
/**
 * SelectItem - RetroUI/NeoBrutalist 스타일 선택 항목
 */
