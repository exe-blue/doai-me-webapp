...
export function Header() {
  return (
    <header className="sticky top-0 h-[var(--header-height)] z-50 p-0 bg-background/60 backdrop-blur">
      <div className="flex justify-between items-center container mx-auto p-2 max-w-[var(--container-max-width)]">
        <Link
          href="/"
          title="brand-logo"
        ...
        <nav className="hidden lg:flex items-center gap-6" aria-label="메인 네비게이션">
          <Link
            href="/tech"
