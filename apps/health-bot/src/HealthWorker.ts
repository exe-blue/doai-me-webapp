...
// Main worker implementation for device health monitoring
// ============================================
 ...
 */
export class HealthWorker extends EventEmitter implements WorkerInterface {
  readonly workerId: string;
  readonly type: WorkerType = 'health';
  ...
  constructor(config: HealthWorkerConfig) {
    ...
    this.logger = config.logger ?? defaultLogger.child('HealthWorker');
    ...
    this.logger.info('HealthWorker initialized', {
  ...
  private registerDefaultHandlers(): void {
    ...
    const healthCheckHandler = new HealthCheckHandler(this.adbController, this.logger);
    this.registerHandler(healthCheckHandler);

    // Register reset handler
    const resetHandler = new ResetHandler(this.adbController, this.logger);
    this.registerHandler(resetHandler);
  }
