...
interface BorderTextProps extends React.HTMLAttributes<HTMLSpanElement> {
  text: string;
}

export const BorderText = forwardRef<HTMLSpanElement, BorderTextProps>(
  ({ text, className, ...props }, ref) => {
    return (
      <div className="flex items-center justify-center">
        <span
          ref={ref}
          style={{ "--text": `'${text.replace(/'/g, "\\'")}'` } as React.CSSProperties}          className={cn(
